<template>
  <div class="bg-black bg-cover  md:bg-contain bg-bottom bg-no-repeat min-h-screen text-white md:py-16 py-5 md:px-16 px-5 items-center justify-center"
  :style="{
  ...
  >
    <div class="text-center md:mt-10 mt-14 pt-14 md:pt-2">
      ...
      <div class="md:w-1/2 mt-8 md:mt-0 px-5 lg:px-16 pt-16">
        <img :src="section1_3" class="w-100 absolute  transform  left-[120px] lg:left-[250px] bottom-[-90px] z-30 motion-preset-pulse-sm motion-duration-20">
