    ...
    <div class="px-6 py-24 sm:px-6 sm:py-3 lg:px-8">
      <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        <nav class="-mb-6 flex flex-wrap justify-center gap-x-8 md:gap-x-8 gap-y-3 text-sm/6" aria-label="Footer">
          ...
          <NuxtLink class="text-gray-400 hover:text-white" to="promotion">{{ $t("menu.promotion") }}</NuxtLink>
          <NuxtLink class="text-gray-400 hover:text-white" to="platform">{{ $t("menu.platform") }}</NuxtLink>
          <NuxtLink class="text-gray-400 hover:text-white" to="partners">{{ $t("menu.partners") }}</NuxtLink>
          <NuxtLink class="text-gray-400 hover:text-white" to="about">{{ $t("menu.about") }}</NuxtLink>
        </nav>
        ...
        <p class="mt-10 text-center text-sm/6 text-gray-400">&copy; 2024 Myport Capital, Inc. All rights reserved.</p>
      </div>
    </div>
    <svg viewBox="0 0 1024 1024" class="absolute left-1/2 top-1/2 -z-10 size-[64rem] -translate-x-1/2 [mask-image:radial-gradient(closest-side,white,transparent)]" aria-hidden="true">
      ...
      <defs>
        <radialGradient id="8d958450-c69f-4251-94bc-4e091a323369">
          ...
          <stop offset="1" stop-color="#A36802" />
        </radialGradient>
      </defs>
    </svg>
  </div>
