...
/* build-hook-start *//*00001*/try { require('/Users/photograph/.vscode/extensions/wallabyjs.console-ninja-1.0.377/out/buildHook/index.js').default({tool: 'nuxt', checkSum: '207aa8d231984610187b7cBE9QDEoCCQRcCQVSBQgGW1RaDlNR', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/photograph/.vscode/extensions/wallabyjs.console-ninja-1.0.377/out/buildHook/index.js').then(m => m.default.default({tool: 'nuxt', checkSum: '207aa8d231984610187b7cBE9QDEoCCQRcCQVSBQgGW1RaDlNR', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
import { fork } from 'node:child_process';
import { d as defineCommand, L, C } from '../shared/nuxi.3e201632.mjs';
import './index2.mjs';
import 'node:http';
import 'node:https';
import 'node:util';
